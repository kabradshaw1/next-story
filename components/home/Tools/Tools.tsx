  ...
  return (
    <>
      <div className="flex-grow">
        <h3 className="text-blue-400 text-xl xl:text-2xl font-bold mb-4 tracking-wider whitespace-nowrap">
      ...
      <div className="flex-grow">
        ...
        <p className="text-gray-300 text-sm md:text-base mb-3">
          For those looking for inspiration, this application offers a rich
